...
@include('insert')  --}}
    <div class="d-flex p-3" >
         ...
         <form method="POST" action="{{ url('/store/tracking') }}">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" id="product" value="{{ $order->product }}" class="form-control" name="product" placeholder="Product">
            </div>
            <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Product code</label>
                <input type="text" id="code" class="form-control" value="{{ $order->code }}" name="code" placeholder="Product code">
            </div>
            <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Order status</label>
                <input type="text" id="newprice"  name="status" class="form-control" placeholder="Order status">
            </div>
