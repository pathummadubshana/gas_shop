...
@include('insert')  --}}
    <div class="d-flex p-3" >
         ...
         <form method="POST" action="{{ url('product') }}">
            ...
            <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Cutomer name</label>
                <input type="text" id="product" class="form-control" name="product" placeholder="Cutomer name">
            </div>
            <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Email</label>
                <input type="text" id="code" class="form-control" name="code" placeholder="Email">
            </div>
            <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Mobile</label>
                <input type="text" id="newprice"  name="Mprice" class="form-control" placeholder="Mobile">
            </div>
            <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Adress</label>
                <input type="text" id="Refilprice" name="Rprice" class="form-control" placeholder="Adress">
            </div>
            <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Area</label>
                <input type="text" id="empty" name="Eprice" class="form-control" placeholder="Area">
            </div>
            <div class="mb-3">
