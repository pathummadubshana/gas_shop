...
@include('insert')  --}}
            ...
            <div>
                <div class="d-inline-flex " style >
                    <div class="mb-3">
                        ...
                        <input type="text" id="Vat_num" class="form-control" name="vatnum" placeholder="Vat num">
                    </div>
                    <div class="mb-3" style="padding-left: 5%">
                        <label for="disabledTextInput" class="form-label">S-vat</label>
                        <input type="text" id="Svat" class="form-control" name="Svat" placeholder="S-vat">
                    </div>
    ...
    @include('admin.customer.customdata')
